...
def run_job_search_pipeline(job_title):
    ...
    try:
        ...
        scripts = ["./job_extraction/job_search.py", "./job_extraction/job_url_details.py"]
        ...
        logging.info(f"Running ./job_extraction/job_search.py with arguments: {cmd}")
        ...
        if process.returncode != 0:
            ...
            logging.error(f"Error executing ./job_extraction/job_search.py: {error_output}")
